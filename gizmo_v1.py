...
'''
This is a release file for controlling the gizmo. It is built on the threaded model for the control system. It uses threads to run both components of the Gizmo (motor and solenoid) in unison. Circuit diagram can be found in the documentation. Pin layout and wiring included in documentation.
...
N.B this file still has bugs. Ultimately development was abandonded due to 'Python interpreter re. threading' problems.
'''
...
def solenoid(queue):
    ...
    while True:
        ...
        while not queue.qsize() == 0: # check if Q has item
            ...
            print queue.qsize(), colour.red+"Q size"+colour.end
            print timenow,colour.red+"time now for solenoids"+colour.end
            print timestamp,colour.red+"time stamp (solenoids)"+colour.end
            ...
            if delay >= 0:
                ...
                print datetime.datetime.now(), "- Play solenoids with brush"# print an execution statement with timestamp
            ...
            #         print delay_fractional,"delay_fractional"
            #         if shouldExitThread: return
            ...
            #         notes = tune[line_number]
            #
            #         print datetime.datetime.now(), "- Play solenoids alone"# print an execution statement with timestamp
            #         print line_number, notes
            #
            #         if notes[1] == '1':
            #             hit1 = True
        ...
        while not file_is_finished:
            if GPIO.input(switch1) and not GPIO.input(switch2):  # button is released
                ...
                if not flag:
                    ...
                    print timenow,colour.green+"time now for main"+colour.end
                    print prediction,colour.green+"prediction"+colour.end
